/**
 * GET /api/ai/sleep-brief?date=2026-04-19
 *
 * Devuelve el sleep_brief_ai.json si ya existe (caché).
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    console.error("[ai/sleep-brief] Error:", msg);
    return NextResponse.json({ ok: false, error: "No se pudo generar el análisis de sueño." }, { status: 500 });
  }
}
